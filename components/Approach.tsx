...
import { myApproachData } from "@/data";
        ...
        {myApproachData.map((item) => (
            <Card
                ...
                <CanvasRevealEffect
                    ...
                    dotSize={item.dotSize && item.dotSize}
                />
            </Card>
        ))}
      </div>
  ...
  return (
    <div>
        <button className="bg-slate-800 no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-full p-px text-xs font-semibold leading-6  text-white inline-block">
            ...
            <div className="relative flex space-x-2 w-full items-center z-10 rounded-full bg-zinc-150 ring-1 ring-white/10 ">
                <span
